...
$(document).ready(function(){
	...
	// On cache le path si le titre est trop long
	var title = $('#title h1');
	var titleText = title.text();
	var path = $('#path');
	var pathText = path.children('a').text()
	var divLength = 5*titleText.length + pathText.length;
	var newDivLength = 3*titleText.length + pathText.length;
	var limit = 180;
